...
你可以使用此脚本,[下载](https://github.com/lilingfengdev/NitWiki-Script/releases/download/latest/select-server.py),可以帮你选择服务器核心并**自动下载**
...
| [Leaf](https://github.com/Winds-Studio/Leaf) | 基于Gale的优化和purpur的功能，开发者为[@Dreeam](https://github.com/Dreeam-qwq) 梦梦，拥有非常棒性能（不算叶子），支持中文名进服，拥有较好的稳定性（已知不兼容只有一个）| 非常推荐 | 暂无 |
