...
性能较好，是初学者最适合开的服务器，拓展性较强，配置性强，但坏处就是有的插件需自行配置后使用，客户端无需安装MOD。我个人推荐插件服使用Purpur, 是截止到2024年的稳定性和优化最好的选择, 当然，Paper 稳定性最好,但是优化实在不咋地
...
| [Beast](https://github.com/HomoMC/Beast) | Paper 1.12.2 分支旨在提供极致性能、错误修复和改进。推荐使用Java 21以上 | 推荐 | 暂无 |
| [Paper](https://papermc.io/) | 稳定性最好的核心,但是性能在高，版本不太好 | 推荐 | [McRes](https://mcres.cn/downloads/paper.html) |
