...
区分的方式是英特尔 CPU 后面带 K ，比如 10600K、12700KF ，AMD 的 CPU 后面带 X，比如5600X、7950X。级别更高的CPU往往核心数和单核性能都更高。要开的服务器规模越大，就越有必要选购更高端的CPU。
...
2. 主芯片组。主芯片组必须要和CPU品牌对应，才能和CPU兼容。英特尔有中端的 B 系列和高端的 Z 系列，AMD 有中端的 B 系列和高端的 X 系列。通常不需要考虑主芯片组要选哪个，毕竟你也不需要给服务器主板插一大堆三件。
...
选购机械硬盘时，需要注意以下事项：
1. 机械硬盘的 IO速度 远低于固态硬盘，不要只因为机械硬盘便宜，就去选购机械硬盘！
